...
FOR EACH PAPER ABSTRACT PROVIDED, return valid JSON matching this exact schema:
{
  ...
  "verdict": string,        // ONE concrete, actionable implication derived directly from the paper's findings. The domain of the verdict must match the domain of the paper — if the paper is about education, the verdict is for educators; if it's about clinical AI, the verdict is for clinicians; if it's about product design, then and only then is it a design constraint. Never default to "designers should..." if the paper is not about design. Use specific parameters where possible: numbers, thresholds, conditions. Example for education: "Students who use AI for first-draft writing without a mandatory revision gate show 40% lower retention of their own argument structure after 3 weeks — require a no-AI rewrite step before submission." Example for design: "Any AI system handling more than 3 sequential tasks without human confirmation creates measurable memory erosion within 6 weeks — build a review gate."
  "methodology": string,    // 1-2 sentences. How was the research conducted? e.g. "Randomized controlled trial with 120 participants over 6 weeks, using pre/post cognitive assessments." or "Meta-analysis of 34 studies covering 8,000+ participants."
  "threat_vector": string,  // 1-2 sentences. The specific cognitive or behavioral mechanism being exploited or at risk. e.g. "Automation bias triggered by anthropomorphic AI framing, eroding verification behavior in high-stakes decisions."
